...
module.exports = {
    ...
    THRESHOLDS: { AI_BUY_SCORE: 85, AI_SELL_SCORE: -85, AI_WATCH_SCORE: 60, DASHBOARD_MIN_SCORE: 85, DASHBOARD_MAX_ROWS: 10, MIN_CONFIDENCE: 70, MIN_RR: 1.5, PRE_SCORE_MIN: 0, DAILY_CANDLE_MIN: 50, MAX_QUALIFIED_STOCKS: 20 },
    AI_BUY_SCORE: 85,
    AI_SELL_SCORE: -85,
    AI_WATCH_SCORE: 60,
